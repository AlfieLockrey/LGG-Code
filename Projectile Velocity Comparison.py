...
E1Path = 'Model + Exp. Data CSVs/Riad Model 1 8g12.7mm17g Projectile Velocity.csv'
...
def Compare(modelPath, expPath, dx_e=0, dy_e=0):
    ...
    mod_x, mod_y = ReadIn(modelPath, n=4, m=1)
    ...
    title = 'Projectile Velocity vs Time: Model vs Experimental'
    xtitle = 'Time (s)'
    ytitle = 'Velocity (mps)'
...
dt = -0.0019084999999999998  # DeltaTPeak(M1Path, E1Path)
